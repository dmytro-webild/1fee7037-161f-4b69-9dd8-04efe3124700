...
export const metadata: Metadata = {
  title: "The Paleta Bar | Luxury Handcrafted Paletas",  description: "Experience premium handcrafted paletas dipped in chocolate and topped with gourmet ingredients. Visit our luxury dessert lounge for an unforgettable indulgence.",  keywords: "paletas, luxury desserts, handcrafted ice cream, chocolate-dipped, premium frozen treats, dessert lounge",  openGraph: {
    title: "The Paleta Bar | Luxury Handcrafted Paletas",    description: "Creamy, rich, and perfectly balanced desserts. Every bite is unforgettable.",    type: "website",    siteName: "The Paleta Bar",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/ice-cream-chocolate-composition_23-2147985542.jpg",        alt: "Luxury chocolate-dipped paleta with premium toppings"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "The Paleta Bar | Handcrafted Luxury Paletas",    description: "Discover our premium paletas dipped in chocolate. Crafted daily with indulgent ingredients.",    images: ["http://img.b2bpic.net/free-photo/ice-cream-chocolate-composition_23-2147985542.jpg"],
  },
};
